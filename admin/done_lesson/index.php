        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					...
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `appointment_list` where status='3' && delete_flag=0 && instructor_id='".$_settings->userdata('id')."' order by unix_timestamp(`schedule`) desc ");
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="./?page=done_lesson/view_details&id=<?php echo $row['id'] ?>" data-id=""><span class="fa fa-window-restore text-gray"></span> View</a>
