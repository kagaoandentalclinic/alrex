        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `appointment_list` where status='1' && delete_flag=0 && instructor_id='' order by unix_timestamp(`schedule`) desc ");
						while($row = $qry->fetch_assoc()):
					?>
						<tr>
							<td class="text-center">00<?php echo $i++; ?></td>
							<td class=""><B><?php echo date("M d, Y",strtotime($row['schedule'])) ?></B></td>
								...
								<?php 
									switch ($row['status']){
										case 0:
											...
											break;
										case 1:
											echo '<span class="rounded-pill badge badge-success">Assign Instructor</span>';
											break;
										case 2:
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="./?page=seasion/view_details&id=<?php echo $row['id'] ?>" data-id=""><span class="fa fa-window-restore text-gray"></span> View</a>
