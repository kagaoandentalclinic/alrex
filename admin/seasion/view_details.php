           ...
           <div class="card-body bg-gradient-dark">
            <div class="container-fluid">
                ...
                <div class="rounded-0 text-center mt-6 bg-gradient-dark">
                    <br>
                         <a class="btn btn-md btn-warning " href="javascript:void(0)" id="healthcare"><i class="fa fa-edit"></i><b>Assign Instructor</b></a>
                        ...
                        <a class="btn btn-light border  btn-md" href="./?page=seasion" ><i class="fa fa-angle-left"></i> Back to List</a>
                        <hr>
...
<script>
    $(function(){
            ...
            uni_modal("Assign Instructor","seasion/vaccination.php?id=<?= $id ?>&status=<?= $status ?>&userid=<?= $clientid ?>&Student_name=<?= $requestor ?>&refnum=<?= $code ?>")
        })
        ...
        $('#update_status').click(function(){
            uni_modal("Update Status","seasion/update_status.php?id=<?= $id ?>&status=<?= $status ?>&clientid=<?= $clientid ?>&code=<?= $code ?>")
        })
    })
