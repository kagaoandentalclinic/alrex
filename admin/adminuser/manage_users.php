...
<table style="width:100%">
  ...
  <tr>
    <td>Department: <b><?php echo isset($meta['department']) ? $meta['department']: '' ?></b></td>
    <td></td>
   <td>Date of Birth: <b><?php echo isset($meta['dob']) ? $meta['dob']: '' ?></b></td>
  </tr>

  <tr>
    <td>Employment Status: <b><?php echo isset($meta['empstatus']) ? $meta['empstatus']: '' ?></b></td>
    <td>Type: <b>
        <?php switch ($meta['type']){

   
    case '	3		 ':echo '	Staff	';break;
    case '	4		 ':echo '	Faculty';break;
    case '	5		 ':echo '	Student';break;
        }
    ?>
    
</b></td>
   <td>College: <b><?php echo isset($meta['college']) ? $meta['college']: '' ?></b></td>
  </tr>
...
case	16	:	echo '	Region XIII (Caraga)	';break;
  ...
  <table style="width:100%">
   ...
   <tr>
    ...
    <td>Mother Name: &nbsp;<b><?php echo isset($meta['mother']) ? $meta['mother']: '' ?></b></td>  
    <td>Father Name: <b><?php echo isset($meta['father']) ? $meta['father']: '' ?></b></td> 
    <td>Id Number: <b><?php echo isset($meta['idnumber']) ? $meta['idnumber']: '' ?></b></td>
        <td></td>
  </tr>
   <tr>
     <td>Age: <b><?php echo isset($meta['age']) ? $meta['age']: '' ?></b></td>
      <td>Sex: <b><?php echo isset($meta['sex']) ? $meta['sex']: '' ?></b></td>
           <td>Civil: <b><?php echo isset($meta['civil']) ? $meta['civil']: '' ?></b></td>
  </tr>
</table>
