...
<b>
Medical and Dental Service Unit<BR>STAFF INFORMATION LIST</BR>
	...
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-user-nurse"></span>  Add New User</a>
		</div>
	</div>
	<div class="card-body">
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=user/manage_users&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> View</a>
