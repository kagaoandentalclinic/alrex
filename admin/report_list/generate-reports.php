...
<?php 
                        $i = 1;
                       $qry = $conn->query("SELECT *, CONCAT(firstname, ' ', lastname) AS name FROM `users` WHERE type IN ('3', '4', '5') AND DATE(date_added) BETWEEN '$fdate' AND '$tdate' ORDER BY CONCAT(firstname, ' ', lastname) ASC");
...
<center>
 ...
 <a href="report_list/print_report.php?fday=<?php echo $fdate;?>&lday=<?php echo $tdate;?>"><button type="button" class="btn btn-lg btn-warning"> <i class="fa fa-print"></i></button></center>
