...
<b>
ALREX DRIVING SCHOOL<BR>STUDENT INFORMATION LIST</BR>
	...
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=student/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-user"></span>  Add New User</a>
		</div>
	</div>
	<div class="card-body">
