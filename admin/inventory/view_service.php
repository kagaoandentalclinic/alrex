...
<div class="container-fluid">
    <dl>
        ...
        <dd class='pl-4 fs-4 fw-bold'><?= isset($prodname) ? $prodname : '' ?></dd>
        <dt class="text-muted">Product For:</dt>
        <dd class='pl-4'>
        ...
        <dt class="text-muted">Stock</dt>
          <dd class='pl-4 fs-4 fw-bold'><?= isset($stock) ? $stock : '' ?></dd>
              <dt class="text-muted">Expiration Date</dt>
          <dd class='pl-4 fs-4 fw-bold'><?= isset($expired) ? $expired : '' ?></dd>
    </dl>
