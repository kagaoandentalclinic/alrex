...
<div class="container-fluid">
    ...
    <div class="form-group">
            <label for="one" class="control-label">Deduct Stock</label>
            <input type="number" step="any" name="one" id="one" class="form-control form-control-border text-right" placeholder="Enter the number to deduct" value ="" required>
        </div>
...
<script>
    ...
    $(function(){
        ...
        $('#uni_modal #service-form').submit(function(e){
            ...
            start_loader();
            $.ajax({
                url:_base_url_+"classes/Master.php?f=deduct_stock",
