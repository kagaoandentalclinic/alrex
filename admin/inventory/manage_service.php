...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="prodname" id="prodname" class="form-control form-control-border" placeholder="Enter Product Name" value ="<?php echo isset($prodname) ? $prodname : '' ?>" required>
        </div>
        <div class="form-group">
...
<div class="form-group">
            <label for="expired" class="control-label">Expiration Date</label>
            <input type="date" name="expired" id="expired" class="form-control form-control-border" placeholder="select Expiration date" value ="<?php echo isset($expired) ? $expired : '' ?>" required>
        </div>

        <div class="form-group">
            <label for="price" class="control-label">Price</label>
            <input type="number" step="any" name="price" id="price" class="form-control form-control-border text-right" placeholder="Enter price" value ="<?php echo isset($price) ? $price : 0 ?>" required>
        </div>
