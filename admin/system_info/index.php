	...
	<div class="card card-outline card-dark rounded-0 shadow">
		...
		<div class="card-body">
			...
			<fieldset>
				...
				<div class="form-group">
					<label for="time_schedule" class="control-label">Clinic Daily Schedule <small><em>i.e.(8:00 AM - 5:30 PM)</em></small></label>
					<input type="text" class="form-control form-control-sm col-sm-3" name="time_schedule" id="time_schedule" value="<?php echo $_settings->info('time_schedule') ?>">
				</div>
			</fieldset>
			</form>
		</div>
