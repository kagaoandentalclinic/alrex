...
<div class="card ">
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					<?php 
						...
						$qry = $conn->query("SELECT * from `notification`  order by (`date_created`) desc ");
					...
					?>
						<tr>
							...
							<td class="text-left">Good day sir/maam, Your Appointment Code: <?php echo ($row['code']) ?> update your status into <?php 
								...
								?> in this date <?php echo date("M d, Y",strtotime($row['date_created'])) ?>. Please see in your appointment list monitoring. </td>
	...
	<td class="text-center"><?php 
		                    ...
		                    <div class="dropdown-menu" style=""> <a class="dropdown-item edit_department" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Read</a>
...
<script>
	...
	$('.edit_department').click(function(){
		uni_modal("View ","notification/manage_notif.php?id="+$(this).attr('data-id'))
	})
