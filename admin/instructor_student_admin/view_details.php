            ...
            <div class="container-fluid">
                ...
                <div class="rounded-0 text-center mt-6 bg-gradient-dark">
                    <br>
                        ...
                        <a class="btn btn-light border  btn-md" href="./?page=instructor_student_admin" ><i class="fa fa-angle-left"></i> Back to List</a>
                        <hr>
...
<table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT * from `student_remarks` where userid='$clientid'order by unix_timestamp(`date_created`) desc  ");
