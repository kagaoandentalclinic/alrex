...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Alrex Driving School Schedule Settings</h5>
		</div>
		<div class="card-body">
			<form action="" id="schedule_settings">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group mt-3">
                        <label for="max_appointment" class="control-label">Maximum Appointments Per Day</label>
                        <input type="number" class="form-control col-sm-4" name="max_appointment" id="max_appointment" min="1" value="<?php echo $_settings->info('max_appointment') ?: 10 ?>">
                        <small class="text-muted">Controls the daily booking slot limit.</small>
                    </div>
                </div>
                </div>
			</form>
