            ...
            <form action="" id="manage-user">
                ...
                <div class="flex-container">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sufix" id="extension" class="form-control" value="<?php echo isset($meta['sufix']) ? $meta['sufix'] : '' ?>">
                    </div>
                </div>
                ...
                <div class="flex-container">
                    <div class="form-group">
                        ...
                        <input type="date" id="dob" name="dob" class="form-control" onchange="calculateAge()" value="<?php echo isset($meta['dob']) ? $meta['dob'] : '' ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="age" name="age" class="form-control" readonly value="<?php echo isset($meta['age']) ? $meta['age'] : '' ?>">
                    </div>
                    &nbsp;&nbsp;
                </div>
...
<div class="card-footer">
    <div class="col-md-12">
        <div class="row">
            <button class="btn btn-primary" form="manage-user"><i class="fa fa-save"></i> Update Details</button>
        </div>
    </div>
</div>
<style>
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp == 1) {
                    ...
                    var msg=resp;if(resp.indexOf('ERR:')===0){try{msg=atob(resp.substring(4));}catch(e){}}$('#msg').html('<div class="alert alert-danger">'+msg+'</div>')
                    end_loader()
                }
            }
        })
