...
ALREX DRIVING SCHOOL<BR>Generate Report For Appointment List</BR>
 ...
 <div class="form-group">
   ...
   <div class="form-group">
	...
	<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `appointment_list` where  date(schedule) between '$fdate' and '$tdate' && delete_flag=0   AND status NOT IN (0, 1) AND status='$status' order by (`requestor`) desc ");
...
<center>
 ...
 <a href="report/print_report.php?fday=<?php echo $fdate;?>&lday=<?php echo $tdate;?>&stat=<?php echo $status;?>"><button type="button" class="btn btn-lg btn-warning"> <i class="fa fa-print"></i></button></center>
