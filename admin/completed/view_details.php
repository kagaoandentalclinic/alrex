...
<div class="content py-3">
            ...
            <div class="container-fluid">
                         ...
                         <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    switch ($payment){
                                        case 0:
                                            echo '<span class="ml-4 rounded-pill badge badge-danger">NOT PAID</span>';
                                            break;
                                        case 1:
                                            echo '<span class="ml-4 rounded-pill badge badge-success">PAID</span>';
                                            break;
 ...
 <?php if($_settings->userdata('type') == 2): ?>
  ...
  <a class="btn btn-md btn-success " href="?page=user/manage_users&id=<?= ($clientid) ?>"><i class="fa fa-edit"></i>Print Result</a>
...
<?php endif; ?>
 ...
 <?php if($_settings->userdata('type') == 1): ?>
                        ...
                        <a class="btn btn-md btn-primary btn-flat" href="javascript:void(0)" id="update_status"><i class="fa fa-edit"></i>Set Appointment Date</a>
                         ...
                         <a class="btn btn-md btn-success " href="?page=completed/manage_users&id=<?= ($clientid) ?>&codes=<?= ($code) ?>"><i class="fa fa-edit"></i>Print Result</a>
                         <a class="btn btn-light border btn-flat btn-md" href="./?page=client" ><i class="fa fa-angle-left"></i> Back to List</a>
