...
<div class="container-fluid">
            ...
            <div class="col-md-6">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="email" name="address" id="address" class="form-control form-control-lg rounded-0" rows="8" placeholder="Lot 2 Block 23, Here Subd., Over There City, Anywhere, 2306" required><?php echo isset($address) ? $address : '' ?></textarea>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Client Information</legend>
                    <div class="form-group">
                        <label for="category_id" class="control-label">Species</label>
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <select name="sex" id="sex" class="form-control form-control-border select2">
   ...
   <label for="age" class="control-label">Agse</label>
                        <select name="age" id="age" class="form-control form-control-border select2">
                        ...
                        <input type="date" name="dateofbirth" id="dateofbirth" class="form-control form-control-border" placeholder="select date" value ="<?php echo isset($dateofbirth) ? $dateofbirth : '' ?>" required>
                    </div>
                </fieldset>
                <div class="form-group">
        ...
        $('#uni_modal #appointment-form').submit(function(e){
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    end_loader();
                        setTimeout(() => {
                            uni_modal("Success","setappointment/success_msg.php?code="+resp.code)
