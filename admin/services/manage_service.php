...
<div class="container-fluid">
    <form action="" id="service-form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Enter Program" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
            <label for="category_ids" class="control-label">For User <small><em>(User Types)</em></small></label>
    ...
    $(function(){
        $('#uni_modal').on('shown.bs.modal',function(){
            $('#category_ids').select2({
                placeholder:"Please Select Patient Type(s) here.",
                width:'100%',
