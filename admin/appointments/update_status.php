        ...
        <input type="hidden" name="id" value="<?= isset($_GET['id']) ? $_GET['id'] : '' ?>">
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select name="payment" id="payment" class="form-control form-control-sm form-control-border" required>
                 <option value="0" <?= isset($payment) && $payment == 0 ? "selected" : "" ?>>Not Yet Paid</option>
                    <option value="1" <?= isset($payment) && $payment == 1 ? "selected" : "" ?>>Paid</option>
...
<script>
    $(function(){
        $('#update-form').submit(function(e){
            ...
            start_loader();
            $.ajax({
                url:_base_url_+"classes/Master.php?f=update_appointment_statussss",
