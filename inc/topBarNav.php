...
<style>
  ...
  .nav-link:hover {
    background-color: #1f355e; /* Change to your desired dark blue color */
    transform: translateX(10px); /* Move forward by 10 pixels */
    /* Add any other CSS properties or animations for the hover effect */
  }
</style>
...
<nav class="main-header navbar navbar-expand navbar-dark border-0 text-sm bg-violet" id="top-Nav">
...
<div class="d-grid gap-2 d-md-flex justify-content-md-end">
  <a href="admin/login.php" class="btn btn-flat btn-sm" style="color: white;">Login</a>
  <!-- <a href="admin/login.php" class="btn btn-flat  btn-sm" style="color: white;"><b>Sign In</b></a> -->
</div>
