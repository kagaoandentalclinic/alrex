            ...
            <div class="card card-outline card-navy rounded-0 shadow">
                ...
                <div class="card-body rounded-0">
                    <dl>
                        ...
                        <dd class="pl-4"><?= $_settings->info('time_schedule') ?></dd>
                        <dt class="text-muted"><i class="fa fa-user"></i> Maximum Daily Appointments</dt>
                ...
                <div class="card-body rounded-0">
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm form-control-border" id="contact" name="contact" required placeholder="09.........">
                                <small class="px-3 text-muted">Contact #</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <input type="email" class="form-control form-control-sm form-control-border" id="email" name="email" required placeholder="juandc@gmail.com">
